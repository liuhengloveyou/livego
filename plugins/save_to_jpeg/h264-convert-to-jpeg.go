...
// #cgo windows CFLAGS: -I D:/dev/av/ffmpeg-6.0-full_build-shared/include
// #cgo windows LDFLAGS: -L D:/dev/av/ffmpeg-6.0-full_build-shared/lib -lavcodec.dll -lavutil.dll -lswscale.dll
//
...
func (d *h264Decoder) decode(nalu []byte) (image.Image, error) {
	...
	res = C.sws_scale(d.swsCtx, frameData(d.srcFrame), frameLineSize(d.srcFrame), 0, d.srcFrame.height, frameData(d.dstFrame), frameLineSize(d.dstFrame))
	if res < 0 {
