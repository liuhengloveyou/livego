...
import (
	...
	"github.com/liuhengloveyou/livego/conf/decrypt"
	"github.com/liuhengloveyou/livego/conf/env"
	"github.com/liuhengloveyou/livego/conf/yaml"
)
...
func loadFromFile(fpath string, conf *Conf) (bool, error) {
	...
	// livego.yml is optional
	// other configuration files are not
	if fpath == "livego.yml" || fpath == "rtsp-simple-server.yml" {
